...
enum Strings { // @DontAdd
	...
	ADD, // "Add"
	ADDED, // "Added"
	ADDING_SHARED_DIR, // "Adding the directory {0} in share..."
	...
	ADD_BUNDLE_ERRORS_OCC, // "The following error(s) occurred when queueing the bundle {0} from a user {1}: {2}"
	ADD_DIRECTORY_QUEUED, // "The directory {0} has been queued to be added in share"
	ADD_DLG_DESC, // "Add also in the following profiles"
	ADD_EMPTY, // "Can't add an empty string"
	ADD_FILE_ERROR, // "Failed to queue the file {0} from a user {1}: {2}"
	...
	ASCH_SUPPORT_COUNT, // "Users with Advanced Search support: {0}/{1}"
	...
	AS_ERROR, // "{0}: {1} (on {2} from a user {3})"
	...
	AS_X_FOUND_FROM, // "A {0} {1} was found from a user {2}"
	...
	AUTOSEARCH_ADDED, // "A new item {0} has been added"
	AUTOSEARCH_ADDED_SEARCHED, // "A new item {0} has been added and it has been searched for"
	AUTOSEARCH_ADDED_SEARCHED_IN, // "A new item {0} has been added and it will be searched for in {1} seconds"
	AUTOSEARCH_ADD_FAILED, // "Failed to add the item {0}: {1}"
	...
	BACKGROUND_UPDATER_START, // "Starting to download a new client version ({0})..."
	...
	BIND_ADDRESS_MISSING, // "The {0} bind address {1} doesn't appear to be available. Do you want to switch to listen to all interfaces?"
	...
	BUNDLE_ALT_SEARCH, // "Searching the bundle {0} for alternatives, {1} search(es) queued."
	BUNDLE_ALT_SEARCH_RECENT, // "Searching alternates for a RECENT bundle {0}, {1} search(es) queued."
	BUNDLE_CREATED, // "The bundle {0} has been created with {1} items"
	BUNDLE_CREATION_FAILED, // "Failed to create the bundle {0}: {1}"
	BUNDLE_FILENAME, // "Bundle / Filename"
	BUNDLE_ITEM_ADDED, // "The file {0} was added into an existing bundle {1}"
	BUNDLE_LOAD_FAILED, // "Failed to load the bundle {0}: {1}. The bundle file has been deleted."
	BUNDLE_MERGED, // "The directory {0} has been merged into an existing bundle {1} ({2} items were merged)"
	BUNDLE_READDED, // "The bundle {0} has been re-added for downloading"
	BUNDLE_REMOVED, // "Bundle removed"
	BUNDLE_REMOVED_AS, // "There's an auto search with the same name associated to the bundle {0}.\r\n\r\nDo you want to remove the auto search item as well?"
	BUNDLE_SHARING_FAILED, // "Failed to add the bundle {0} in share"
	BUNDLE_ERROR_SUBBUNDLES, // "There are {0} items queued inside the path {1}: {2}"
	BUNDLE_X_QUEUED, // "{0} (queued)"
	BUNDLE_X_REMOVED,  // "The bundle {0} has been removed from the queue"
	BUNDLE_X_SHARED, // "The bundle {0} has been added in share"
	BUNDLE_X_FINISHED_WARNING, // "There are {0} finished bundles in queue, please consider removing some of the bundles"
	CANCEL, // "Cancel"
	CANT_OPEN_EMPTY_FILE, // "A zero-byte file can't be opened"
	CANT_OPEN_SFV, // "Failed to open the SFV file"
	CASE_SENSITIVE, // "Case sensitive"
	CCPM_BLOCKED_WARNING, // "The hub {0} has chosen not to allow direct encrypted private message channels, which means that the text is being analyzed by the hub and possibly being read by its operators."
	...
	COMMENT, // "Comment"
	COMPACTING_X, // "Compacting {0}..."
	COMPLETE_ITEM_X_REMOVED, // "A completed item {0} has been removed"
	...
	CONFIRM_PROFILE_REMOVAL, // "Are you sure that you want to remove the profile {0}?"
	CONFIRM_REMOVE_DIR_BUNDLE, // "Are you sure you want to remove the bundle {0}?"
	CONFIRM_REMOVE_DIR_FINISHED, // "Are you sure you want to remove the bundle {0} and its finished files?"
	CONFIRM_REMOVE_DIR_FINISHED_MULTIPLE, // "Are you sure you want to remove {0} bundles and all their finished files?"
	CONFIRM_REMOVE_DIR_MULTIPLE, // "Are you sure you want to remove {0} bundles?"
	CONFIRM_REMOVE_HUBS_FAV_GROUP, // "The group {0} contains {1} hubs, remove all of the hubs as well?\n\nIf you select 'Yes', all of these hubs are going to be deleted!\n\nIf you select 'No', these hubs will simply be moved to the main default group."
	CONFIRM_SIZE_WARNING, // "There is only {0} remaining in the directory {1} while {2} is needed. Do you want to continue?"
	CONNECT, // "Connect"
	CONNECTED, // "Connected"
	...
	CONNECT_REQUEST_SPAM_FROM, // "Connect request spam detected from {0} ({1})"
	...
	CONN_PORT_X_FAILED, // "Unable to open {0} port(s); connectivity settings must be configured manually"
	...
	CREATING_MAGNET_FOR, // "Creating magnet link for a file {0}..."
	CREATING_MAGNET_FOR_X, // "Creating magnet links for {0} files..."
	CURRENT_NUMBER, // "Current number"
	CURRENT_VALUE_X, // "Current value: {0}"
	...
	DAY, // "Day"
	DAYS, // "Days"
	DB_ERROR_HINT, // "You can set the database to be verified and repaired from the \"{0}\" tab in Settings (if needed)"
	DB_OPEN_FAILED, // "Failed to open {0}: {1}\r\n\r\n{2} will now exit."
	DB_OPEN_FAILED_IO, // "Failed to open {0}: {1}\r\n\r\nMake sure that there isn't another instance of {2} using the same settings directory and that the directory {3} is accessible. {4} will now exit."
	DB_OPEN_FAILED_REPAIR, // "Failed to open {0}: {1}\r\n\r\n{2} will now attempt to repair it automatically."
	DB_REPAIR_FAILED, // "Failed to repair {0}: {1}\r\n\r\nMake sure that the path {2} is accessible and there isn't another instance of {3} using the same settings directory. Remove the directory in case the error can't be fixed."
	DB_X_REPAIRED, // "{0} has been verified and repaired successfully. Detailed information about the process has been saved in {1}"
	DECODING_ERROR, // "Received data could not be parsed with encoding {0}"
	DECOMPRESSION_ERROR, // "Error during decompression"
	DECREASE_NUM, // "Decrease current number"
	DEFAULT, // "Default"
	DELETE_FILE, // "Delete file"
	DELETE_FILE_CONFIRM, // "Are you sure you want to delete the file {0}?"
	DESCRIPTION, // "Description"
	DESTINATION, // "Destination"
	DETECT_NOW, // "Detect now"
	DEVICE_REMOVED, // "Device removed"
	DIRECTORY, // "Directory"
	DIRECTORY_ADDED, // "The directory {0} has been added in share"
	DIRECTORY_IS_HIDDEN, // "Directory is hidden"
	DIRECTORY_LOADED, // "The directory {0} has been loaded"
	DIRECTORY_NOT_FOUND, // "Directory not shared"
	DIRECTORY_NOT_REMOVED,  // "The directory {0} isn't empty, not removed"
	DIRECTORY_SUBDIRS_SHARED, // "Subdirectories of the directory are already shared in the following profiles: {0}"
	DIRECTORY_PARENT_SHARED, // "Parent of the directory is already shared in the following profiles: {0}"
	DIRECTORY_REFRESHED, // "The directory {0} has been refreshed"
	DIRECTORY_REFRESH_QUEUED, // "The directory {0} has been queued for refreshing"
	...
	DIR_QUEUED_ALREADY, // "The directory exists in queue: {0}"
	DIR_REFRESH_FAILED, // "Failed to refresh the directory {0}: {1}"
	DIR_SHARED_ALREADY, // "The directory exists in share: {0}"
	DISABLE, // "Disable"
	DISABLED, // "Disabled"
	...
	DL_BUNDLE_FINISHED, // "The bundle {0} has finished downloading"
	...
	DOWNLOADED_BYTES, // "Downloaded {} ({:0.1f}%%) in {}"
	...
	DOWNLOAD_LIMIT_SET_TO, // "Download limit set to {0} KiB/s"
	DOWNLOAD_OPEN, // "Download and open"
	DOWNLOAD_QUEUE, // "Download queue"
	DOWNLOAD_SIGN_FAILED, // "Could not download the digital signature ({0})"
	DOWNLOAD_STARTING, // "Download starting..."
	DOWNLOAD_TO, // "Download to..."
	DOWNLOAD_VERSION_FAILED, // "Could not download the version file ({0})"
	...
	DUPLICATE, // "Duplicate"
	DUPLICATE_FILES_DETECTED, // "{0} duplicate files were detected when generating file list from directories {1}"
	...
	ENABLE_CONNECTIVITY, // "Enable {0} connectivity"
	...
	ERROR_UPDATING_FEED, // "Error updating the feed : {0}"
	...
	EXPIRED, // "Expired"
	EXPIRED_AS_DISABLED, // "An expired item {0} has been disabled"
	EXPIRED_AS_REMOVED, // "An expired item {0} has been removed"
	EXPORT_THEME, // "Export theme"
	EXTENSIONS, // "Extensions"
	EXTENSION_DATA, // "Extension data"
	EXTENSION_INSTALLING_X, // "Installing extension {0}..."
	EXTENSION_UPDATING_X, // "Updating extension {0}..."
	...
	EiB, // "EiB"
	FAILED, // "Failed"
	FAILED_BUNDLE_SEARCHED, // "A failed bundle {0} has been searched for"
	FAILED_BUNDLE_SEARCHED_IN, // "A failed bundle {0} will be searched for in {1} seconds"
	...
	FAILED_TO_OPEN_FILE, // "Failed to open the file {0}: {1}"
	...
	FILE, // "File"
	FILELIST, // "File list"
	FILELIST_LOADED_IN, // "File list has been loaded in {0}"
	FILELIST_ON_DISK, // "File list on disk"
	FILENAME, // "Filename"
	FILES, // "Files"
	FILES_ADDED_FOR_HASH, // "({0} of files have been added for hashing; they won't be visible in the file list until they have finished hashing)"
	FILES_ADDED_FOR_HASH_STARTUP, // "{0} of shared files have been added for hashing as no previous hash information was found for them"
	FILES_LEFT, // "files left"
	FILES_PER_HOUR, // "files/h"
	FILE_ALREADY_FINISHED, // "File is already finished"
	FILE_ALREADY_QUEUED, // "A file with the same hash exists in a queued directory {0}"
	FILE_ALREADY_SHARED, // "Trying to download file already shared! File: "
	FILE_ALREADY_VIEWED, // "The file {0} is being viewed already"
	FILE_CORRUPTION_FOUND, // "{0} of corrupted segments were found"
	...
	FILE_LIST_REFRESH_INITIATED_RPATH, // "File list refresh initiated for the path {0}"
	FILE_LIST_REFRESH_INITIATED_VPATH, // "File list refresh initiated for the virtual directory \"{0}\""
	FILE_LIST_REFRESH_INITIATED_X_PATHS, // "File list refresh initiated for {0} directories"
	...
	FILE_X_QUEUED, // "The file {0} has been added in queue ({1})"
	FILTER, // "Filter"
	FILTERED, // "Filtered"
	FILTER_DOTS, // "Filter..."
	FIND, // "Find"
	...
	FINISHED_DOWNLOAD, // "Download finished: {}"
	FINISHED_DOWNLOADS, // "Finished downloads"
	FINISHED_UPLOAD, // "Upload finished: {} To: {}"
	...
	HASHDB_MAINTENANCE_UNUSED, // "Hash database maintenance completed: {0} unused file entries and {1} unused tree entries have been removed"
	HASHER_X, // "Hasher #{0}"
	HASHER_X_CREATED, // "Hasher #{0} created"
	HASHING, // "Hashing"
	HASHING_FAILED_X, // "Hashing failed: {0}"
	HASHING_FINISHED, // "Hashing finished"
	HASHING_FINISHED_DIR,  // "The directory {0} has finished hashing: {1} files ({2}) have been hashed in {3} ({4})"
	HASHING_FINISHED_FILE,  // "The file {0} ({1}) has finished hashing in {2} ({3})"
	HASHING_FINISHED_TOTAL,  // "Hashing finished: {0} files ({1}) in {2} directories have been hashed in {3} ({4})"
	HASHING_FINISHED_X, // "Finished hashing: {0}"
	HASHING_OPTIONS, // "Hashing options"
	HASHING_X_LEFT, // "Hashing {0}, {1} left"
	HASH_DATA, // "Hash data"
	...
	HBRI_VALIDATING_X, // "Validating the {0} address..."
	HBRI_VALIDATION_FAILED, // "Validation failed: {0}. {1} connectivity has been disabled in this hub."
	HIBERNATE, // "Hibernate"
	...
	HUB_DDOS_DISCONNECT, // "{0}. The hub will be disconnected in order to preserve system resources. If you continue receiving this error, it may indicate that the hub utilizes its users in a DDoS attack."
	HUB_LIST, // "Hublist"
	...
	INCOMING_CONNECT_FLOOD_FROM, // "Incoming connection flood detected from {0}"
	...
	INTEGRITY_CHECK, // "Integrity check: {0} ( {1} )"
	INTEGRITY_CHECK_FAILED, // "File integrity check failed"
	INTEGRITY_CHECK_FINISHED_BUNDLE, // "Integrity check finished for the bundle {0}: {1} of failed segments were found"
	INTEGRITY_CHECK_FINISHED_FILES, // "Integrity check finished: {0} of failed segments were found"
	INTEGRITY_CHECK_START_BUNDLE, // "Integrity check for the bundle {0} started (total bytes to check: {1})"
	INTEGRITY_CHECK_START_FILES, // "Integrity check for {0} files started..."
	INVALID_ENCODING, // "The encoding {0} is invalid or not supported by the system"
	INVALID_EXTENSION, // "Invalid extension: {0}"
	...
	INVALID_PATTERN, // "Invalid pattern: {0}"
	...
	ITEM_SEARCHED, // "{0} has been searched for"
	ITEM_SEARCHED_IN, // "{0} will be searched in {1} seconds"
	ITEM_SEARCHED_RECENT, // "Recent item {0} has been searched for"
	ITEM_SEARCHED_IN_RECENT, // "Recent item {0} will be searched in {1} seconds"
	...
	LANGUAGE_UPDATED, // "The language \"{0}\" has been successfully updated. Changes will take effect after restarting the client."
	LANGUAGE_UPDATE_FAILED, // "Failed to update the language \"{0}\" ({1})"
	...
	LIB_CRASH, // "Application ""{}"" caused an unhandled exception in AirDC++. Please uninstall it, upgrade it or use an alternate product."
	LIMIT, // "Upload limit"
	...
	LIST_LOAD_FAILED, // "Failed to load the file list {0}: {1}"
	LIST_SIZE_DIFF_NOTE, // "The share size in hub {0} ({1}) is different than in the current hub {2} ({3}). Do you want to reload the list?"
	...
	LOAD_FAILED_X, // "Failed to load the file {0}: {1}"
	LOCATIONS, // "Locations"
	...
	MAGNET_CREATED_FOR, // "Magnet link was created for a file {0}"
	MAGNET_CREATED_FOR_X, // "Magnet links were created for {0} files"
	...
	MAGNET_INFOTEXT, // "A magnet link was detected for a file \"{0}\" ({1}). Please choose the action to perform."
	...
	MANUALLY_CONFIGURED_MSG, // "There are {0} settings that have manually set values. Do you want to replace those with the predefined values used by the profile {1}?"
	...
	MAPPER_CREATING_SUCCESS, // "Successfully created port mappings on the {0} device with the {1} interface"
	MAPPER_CREATING_SUCCESS_LONG, // "Successfully created port mappings (Transfers: {0}, Search: {2}, Encrypted transfers: {1}) on the {3} device with the {4} interface"
	MAPPER_INIT_FAILED, // "Failed to initialize the {0} interface"
	MAPPER_INTERFACE_FAILED, // "Failed to map the {0} port ({1} {2}) with the {3} interface"
	...
	MAPPER_REMOVING_FAILED, // "Failed to remove port mappings from the {0} device with the {1} interface"
	MAPPER_REMOVING_SUCCESS, // "Successfully removed port mappings from the {0} device with the {1} interface"
	MAPPER_X_PORT_X, // "{0} {1} port ({2} {3})"
	MATCH, // "Match"
	MATCHED_FILES_BUNDLE, // "Matched {0} file(s) in the bundle {1}, of which {2} were new"
	MATCHED_FILES_X_BUNDLES, // "Matched {0} file(s) in {1} bundles, of which {2} were new"
	...
	MATCH_SOURCE_ADDED, // "Added as source for {0} items in the bundle {1}"
	...
	MENU_VIEW, // "View"
	MENU_WINDOW, // "Window"
	MESSAGES_SENT_THROUGH, // "Messages are now sent through the hub {0}"
	MESSAGES_SENT_THROUGH_REMOTE, // "Messages are now sent through the hub {0} (changed by the remote users)"
	...
	MOVE, // "Move"
	MOVE_DOWN, // "Move down"
	MOVE_FILE_FAILED, // "Failed to move the file {0} to {1} ({2})"
	MOVE_UP, // "Move up"
	...
	NEXT_RECENT_SEARCH_IN, // "Next recent search in {0} minutes"
	NEXT_SEARCH_IN, // "Next search in {0} minutes"
	NICK, // "Nick"
	...
	NOT_IN_SHARED_DIR, // "The bundle {0} isn't in a shared folder, please add it in share manually"
	...
	NO_FILES_WERE_LOADED, // "No files were loaded for {0}"
	...
	OPEN_HUB_FILELIST, // "Open hub file list ({0})"
	...
	PAUSED_PCT, // "Paused ({:0.1f}%%)"
	PAUSED_UNTIL_X, // "Paused until {0}"
	PAUSE_SEARCH, // "Pause search"
	PBITS, // "Pbit/s"
	PERFORM_X_REMAINING, // "Perform this action for {0} remaining items"
	...
	PM_MAGNET_SHARED_WARNING, // "The download destination {0} is a shared directory. Files sent in private chat may contain sensitive information that you or the sender don't want to be made available for other user.\r\n\r\nDo you want to use this destination anyway?"
	...
	PORT, // "Port"
	PORT_BYSY, // "Unable to open {0} port. Searching or file transfers will not work correctly until you change settings or turn off any application that might be using that port."
	...
	PROFILE_VALUE_X, // "Profile value: {0}"
	...
	READ_FAILED_X, // "Failed to read from {0}: {1}"
	REALLY_CLOSE, // "Really close?"
	REALLY_EXIT, // "Really exit?"
	REALLY_REMOVE, // "Really remove?"
	REASON, // "Reason"
	REBOOT, // "Reboot"
	REBUILD_FAILED_ENTRIES_OPTIMIZE, // "{0} shared TTHs without a corresponding hash tree entry were found"
	REBUILD_FAILED_ENTRIES_VERIFY, // "There were {0} shared TTHs without a corresponding hash tree entry and {1} invalid tree entries that couldn't be loaded"
	REBUILD_REFRESH_PROMPT, // "It's recommended to refresh your share as those files (total of {0}) must be rehashed if they are still shared"
	RECENT, // "Recent"
	RECENTS, // "Recents"
	...
	RELOAD, // "Reload"
	REMOTE, // "Remote"
	REMOTE_PROTOCOL_UNSUPPORTED, // "The remote user doesn't support {0} protocol"
	REMOVE, // "Remove"
	...
	RUNNING_PCT, // "Running ({:0.1f}%%)"
	SAMPLE_TEXT, // "Sample text"
	SATURDAY, // "Saturday"
	SAVE_DEFAULT, // "Save in the default download directory"
	SAVE_FAILED_X, // "Failed to save the file {0}: {1}"
	...
	SEARCH_DISABLED_X, // "Search disabled: {0}"
	...
	SEARCH_SPAM_FROM, // "Search spam detected from {0} ({1})"
	...
	SETTING_FILE_RECOVERED, // "Settings were recovered from the file {0} that was saved on {1}. The corrupted file has been renamed to {2} (it can safely be removed). Some recent changes may have been lost."
	SETTING_DONT_DL_ALREADY_QUEUED, // "Don't download files already in queue"
	SETTING_NAME_X, // "Setting name: {0}"
	...
	SFV_TOO_LARGE, // "The SFV file is too large to be loaded ({0})"
	SHARED, // "Shared"
	SHARED_DIR_REMOVED, // "The directory {0} has been removed from the share"
	SHARED_DUPE_PATHS, // "Dupe paths (share)"
	SHARED_FILES, // "Shared files"
	SHARED_FILE_ADDED, // "The file {0} has been added in share"
	SHARE, // "Share"
	SHARE_CACHE_FILE_MISSING, // "Cache file missing for root {0}"
	SHARE_FILES_BLOCKED, // "Some of the files from directory {0} won't be shared: {1}"
	SHARE_DIRECTORY_BLOCKED, // "Directory {0} won't be shared: {1}"
	SHARE_HIDDEN, // "Share hidden"
	SHARE_PROFILE, // "Share profile"
	SHARE_PROFILES, // "Share profiles"
	SHELL_MENU, // "Shell menu"
	SHELL_MENUS, // "Shell menus"
	SHELL_MENU_FAILED, // "Failed to load the menu for {0}"
	...
	SOCKS_SETUP_ERROR, // "Failed to initialize UDP connectivity for SOCKS5 ({0}). The configured SOCKS5 server may not support UDP connectivity. WARNING: UDP traffic will be sent directly to other users without the proxy server."
	...
	SOURCE_ADD_ERROR, // "Failed to add source ({0})"
	...
	TREE_LOAD_FAILED, // "Failed to load hash data for a TTH root {0}: {1} (consider verifying the hash database by typing /verifydb)"
	TREE_LOAD_FAILED_DB, // "Failed to load hash data for a TTH root {0}: {1} (consider verifying your databases by typing {2})"
	...
	TTH_ALREADY_SHARED, // "A file with the same hash exists in a shared directory {0}"
	...
	UNABLE_TO_RENAME, // "Unable to rename {0}: {1}"
	...
	UPDATE_FAILED, // "Failed to install the update (see {0} for more details)"
	...
	UPDATING, // "Updating"
	UPDATING_FAILED, // "Updating failed: {0}"
	UPDATING_VIEW, // "Updating the view..."
	UPLOADED, // "Uploaded"
	UPLOADED_BYTES, // "Uploaded {} ({:0.1f}%%) in {}"
	...
	UPLOAD_LIMIT_SET_TO, // "Upload limit set to {0} KiB/s"
	...
	USER_OFFLINE_PM_CHANGE, // "User went offline in {0}, messages are now sent through the hub {1}"
	...
	VERIFY_CERT_FAILED, // "Certificate verification for subject: {0} failed with error: {1} (certificate keyprint: {2})"
	VERSION, // "Version"
	VERSION_CHECK_FAILED, // "Failed to check for new version: {0}"
	VERSION_PARSING_FAILED,  // "Could not parse the version data ({0})"
	VERSION_VERIFY_FAILED,  // "Could not verify the version data"
	VIDEO, // "Video"
	VIEWED_FILE_TOO_BIG, // "The file {0} is too big to be viewed in the client (the file size is {1} while the limit is 1 MiB)"
	VIEW_AS_TEXT, // "View as text"
	VIEW_HISTORY, // "View chat history"
	VIEW_NFO, // "Find and view NFO"
	VIRTUAL_DIRECTORY_REFRESHED, // "The virtual directory {0} has been refreshed"
	VIRTUAL_NAME, // "Virtual name"
	VIRTUAL_NAME_LONG, // "Name under which the others see the directory"
	VIRTUAL_REFRESH_QUEUED, // "The virtual directory {0} has been queued for refreshing"
	WAITING, // "Waiting"
	WAITING_LEFT, // "Waiting ({0} left)"
	WAITING_PCT, // "Waiting ({:0.1f}%%)"
	...
	WEB_SERVER_START_FAILED, // "Failed to start web server: {0}"
	...
	WEB_UI_ACCESS_URL, // "Web user interface can be viewed at {0}"
	...
	WRITE_FAILED_X, // "Failed to write into {0}: {1}"
	WRONG_PASS, // "Wrong password"
	X_BUNDLES, // "{0} bundles"
	X_BUNDLES_QUEUED, // "{0} bundles queued"
	X_BUNDLE_ITEMS_ADDED, // "{0} items were added into an existing bundle {1}"
	X_BYTES_FREE, // "{0} ({1} free)"
	X_CONNECTIONS, // "{0} connection(s)"
	X_DOWNLOAD_FAILED_X, // "{0}: download failed ({1})"
	X_DIRECTORIES_REFRESHED, // "{0} directories have been refreshed"
	X_DUPE_FOLDERS, // "{0} duplicate folders"
	X_EMPTY_FOLDERS, // "{0} empty folders"
	X_FAILED_SHARING, // "{0} (failed sharing)"
	X_FILES, // "{0} files"
	X_FILES_ADDED_FOR_HASH, // "{0} files ({1}) from the directory {2} have been added for hashing; they won't be visible in the file list until they have finished hashing"
	X_FILES_FAILED_HASHING, // "{0} files failed to hash"
	X_FILE_COUNT, // "{0} ({1} out of {2} files were affected)"
	X_FILE_NAMES, // "{0} (affected file(s): {1})"
	X_FINISHED_BUNDLES, // "{0} finished bundle(s)"
	X_FOLDERS, // "{0} folders"
	X_MISSING_FILES, // "{0} (missing files)"
	X_PARSING_FAILED_X, // "{0}: parsing failed ({1})"
	X_PROFILE_DIRS_EXISTS, // "This directory also exists in {0} other profile(s)"
	X_RESULTS_FOUND, // "Results were found from {0} directories"
	X_THREADS, // "{0} threads"
	X_USERS, // "{0} users"
	X_USERS_WAITING, // "{0} user(s) ({1} waiting)"
	X_REQUESTS_SECONDS, // "{0} requests were received within {1} seconds"
	YEAR, // "Year"
	YEARS, // "Years"
	YES, // "Yes"
	...
	WEB_SERVER_SETUP_FAILED, // "Failed to set up {0} server on port {1}: {2} (is the port in use by another application?)"
	WEB_SERVER_MULTIPLE_FAILED_ATTEMPTS, // "Multiple failed login attempts detected from IP {0}"
	...
	X_EXTENSIONS_LOADED, // "{0} extensions were loaded"
	X_DEBUG_MODE, // "{0} (debug mode)"

	WEB_EXTENSION_INIT_TIMED_OUT, // "Initialization timed out for an extension {0}"
	WEB_EXTENSION_LOAD_ERROR_X, // "Failed to load the extension {0}: {1}"
	WEB_EXTENSION_LOAD_ERROR, // "Failed to load the extension"
	WEB_EXTENSION_START_ERROR, // "Failed to start the extension {0}: {1}"
	WEB_EXTENSION_INSTALLED, // "Extension {0} was installed successfully"
	WEB_EXTENSION_UNINSTALLED, // "Extension {0} was uninstalled"
	WEB_EXTENSION_UNINSTALL_BLOCKED, // "Uninstalling a blocked extension {0} ({1})..."
	WEB_EXTENSION_UPDATED, // "Extension {0} was updated successfully"
	WEB_EXTENSION_INSTALLATION_FAILED, // "Failed to install the extension {0}: {1}"
	WEB_EXTENSION_EXISTS, // "Extension with the same name exists already"
	WEB_EXTENSION_EXITED, // "Extension {0} has exited (see the extension log {1} for error details)"
	WEB_EXTENSION_TIMED_OUT, // "Extension {0} timed out and was restarted"
	WEB_EXTENSION_TERMINATE_PROCESS_FAILED, // "Failed to terminate the extension process ({0})"
	WEB_EXTENSION_STOP_FAILED, // "Failed to stop the extension {0}: {1}"
	WEB_EXTENSION_ENGINE_NO_CONFIG, // "Scripting engine {0} is not configured in application settings"
	WEB_EXTENSION_ENGINE_NOT_INSTALLED, // "Scripting engine {0} is not installed on the system (tested commands: {1})"
	...
	WEB_EXTENSION_API_VERSION_UNSUPPORTED, // "Extension requires API version {0} while the application uses version {1}"
	WEB_EXTENSION_API_FEATURES_UNSUPPORTED, // "Extension requires API feature level {0} or newer while the application supports feature level {1}"

	WEB_EXTENSION_MAJOR_UPDATE, // "A new major version {0} is available for an extension {1}. It needs to be installed manually."
	WEB_EXTENSION_UPDATE_CHECK_FAILED, // "Could not check updates for an extension {0}: {1}"
